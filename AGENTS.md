...
<!-- SPECKIT START -->
Current active Spec Kit plan: `specs/044-credentialed-session-runtime/plan.md`.
Use it with `specs/044-credentialed-session-runtime/spec.md`,
`specs/044-credentialed-session-runtime/research.md`,
`specs/044-credentialed-session-runtime/data-model.md`,
`specs/044-credentialed-session-runtime/contracts/`, and
`specs/044-credentialed-session-runtime/quickstart.md` for Credentialed Session Runtime
