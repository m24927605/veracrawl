...
| --- | --- | --- | --- | --- |
| 038 | Production Runtime Spec Roadmap | Control the remaining production spec set and prevent ad hoc spec expansion. | 037 | Specs 039-055 are defined with purpose, dependency, and completion gate. |
