...
| 2.4b | AuthorizedSessionAdapter (vault → scope check → Authorization injection → transport → CredentialUseRecord audit) + CredentialUseAuditPort + LoggingCredentialUseAuditWriter | IN_PROGRESS (codex review) | TBD | TBD | TBD |
