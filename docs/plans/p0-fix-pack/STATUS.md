...
| 2.4a | OutboxVaultClient (production CredentialVaultPort) + VaultBackendPort + CredentialAccessAuditPort + InMemoryVaultBackend fixture + LoggingCredentialAccessAuditWriter | IN_PROGRESS (codex review) | TBD | TBD | TBD |
