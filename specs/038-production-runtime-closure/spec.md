...
to a production-capable general-purpose AI agent crawler. Specs 068-087 extend
...
- **Target/V1 boundary**: Specs 039-087 are production sequencing,
...
- **RR-001**: Specs 039-087 are the approved production runtime,
...
| 080 | Crawler Intelligence Optimization Roadmap | Fix the finite post-079 optimization spec set for frontier scoring, DOM understanding, extraction fallback/confidence, dedupe/identity, ranking, cost/recovery/evaluation gates, and runtime wiring. | 075, 079 | Specs 081-087 are defined as post-closure optimization follow-ups without changing the 069-075 production-grade closure gate. |
...
- This spec does not authorize creating additional production implementation
  specs outside 039-087 without first amending this roadmap.

## Success Criteria

- **SC-001**: Specs 039-087 exist as planned spec files with fixed purpose,
